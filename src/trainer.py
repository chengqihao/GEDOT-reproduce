...
class Trainer(object):
    ...
    def init_graph_pairs(self):
            ...
            if self.gn[i] <= 10:
                for j in range(i, train_num):
                    ...
                    if tmp is not None:
                        ...
                        self.training_graphs_small.append(tmp)
        ...
        if self.args.model_name.endswith("small") and self.args.dataset=='IMDB':
            self.training_graphs = self.training_graphs_small
        print("Generate {} training graph pairs.".format(len(self.training_graphs)))
        print("Generate {} small training graph pairs.".format(len(self.training_graphs_small)))
